...
const uint64_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 750000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 7500000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 14000000000;
...
const char     CRYPTONOTE_NAME[]                             = "lutshaba";
